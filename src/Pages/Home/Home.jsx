...
const techGridItems =[
    ...
    },
    {
        image:( <svg xmlns="http://www.w3.org/2000/svg" width="65" height="81.378" viewBox="0 0 89.188 81.378"><path id="Subtraction_23" data-name="Subtraction 23" d="M1.221,2.442a1.221,1.221,0,1,1,1.22-1.22A1.222,1.222,0,0,1,1.221,2.442Z" transform="translate(43.373 64.83)" fill="#6caf45"></path><path id="Subtraction_18" data-name="Subtraction 18" d="M10.037,20.074A10.037,10.037,0,1,1,20.073,10.037,10.048,10.048,0,0,1,10.037,20.074Zm0-17.631a7.594,7.594,0,1,0,7.594,7.594A7.6,7.6,0,0,0,10.037,2.443Z" transform="translate(63.296 41.231)" fill="#6caf45"></path><path id="Subtraction_20" data-name="Subtraction 20" d="M25.2,20.074H1.221A1.223,1.223,0,0,1,0,18.853V15.327C0,7.019,7.261,0,15.856,0A16.318,16.318,0,0,1,28.907,6.491a1.222,1.222,0,0,1-1,1.926,1.223,1.223,0,0,1-1-.517A13.806,13.806,0,0,0,15.856,2.443c-7.271,0-13.414,5.9-13.414,12.884v2.3H25.2a1.221,1.221,0,0,1,0,2.443Z" transform="translate(0 61.304)" fill="#6caf45"></path><path id="Subtraction_22" data-name="Subtraction 22" d="M27.91,20.073H3.932a1.221,1.221,0,1,1,0-2.442H26.689V15.326c0-6.984-6.142-12.884-13.413-12.884A13.807,13.807,0,0,0,2.219,7.9a1.225,1.225,0,0,1-1,.516,1.22,1.22,0,0,1-1-1.926A16.315,16.315,0,0,1,13.276,0C21.87,0,29.131,7.018,29.131,15.326v3.527A1.222,1.222,0,0,1,27.91,20.073Z" transform="translate(60.057 61.304)" fill="#6caf45"></path><path id="Subtraction_19" data-name="Subtraction 19" d="M10.037,20.074A10.037,10.037,0,1,1,20.073,10.037,10.048,10.048,0,0,1,10.037,20.074Zm0-17.631a7.594,7.594,0,1,0,7.594,7.594A7.6,7.6,0,0,0,10.037,2.443Z" transform="translate(5.818 41.231)" fill="#6caf45"></path><path id="Subtraction_17" data-name="Subtraction 17" d="M13.563,27.126A13.563,13.563,0,1,1,27.126,13.563,13.578,13.578,0,0,1,13.563,27.126Zm0-24.683a11.12,11.12,0,1,0,11.121,11.12A11.133,11.133,0,0,0,13.563,2.443Z" transform="translate(31.031 30.652)" fill="#6caf45"></path>
								...
								<path id="Subtraction_24" data-name="Subtraction 24" d="M5.614,7.477a1.227,1.227,0,0,1-1.1-.7A11.18,11.18,0,0,0,.551,2.242,1.221,1.221,0,0,1,1.223,0a1.214,1.214,0,0,1,.669.2,13.62,13.62,0,0,1,4.823,5.53,1.222,1.222,0,0,1-1.1,1.746Z" transform="translate(50.131 66.849)" fill="#6caf45"></path>
							</svg> ),
        title:"14",
        sup:"+",
