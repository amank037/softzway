...
const softwareServices = [
  {
    title: "Custom Microservices Consulting",
  ...
  {
    title: "Custom Microservices Product Development",
  ...
  },
  {
    ...
    description: "Our Microservices experts are globally known for building high-impact solutions across diverse cloud environments. Gain unparalleled scalability and cost efficiency with resilient cloud-native apps."
  },
  {
...
function MicroDev() {
    return (
        ...
        <Tabs />
        <AIDevelopment
            aidevTitle="A Comprehensive Portfolio of Custom Microservices Engineering Services"
            aidevDesc="Our development solutions propel your Microservices to the forefront of the market competition. With the proper utilization of the latest technologies, we, as an experienced Microservices development company, create immersive user experiences that adapt to ever-evolving trends."
