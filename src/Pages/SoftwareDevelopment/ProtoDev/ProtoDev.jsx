...
const softwareServices = [
  {
    title: "Custom Prototype Software Consulting",
  ...
  {
    title: "Custom Prototype Software Product Development",
  ...
  },
  {
    ...
    description: "Our Prototype Software experts are globally known for building high-impact solutions across diverse cloud environments. Gain unparalleled scalability and cost efficiency with resilient cloud-native apps."
  },
  {
  ...
  {
    title: "Legacy Prototype Software Modernization",
...
function ProtoDev() {
    return (
        ...
        <Tabs />
        <AIDevelopment
            aidevTitle="A Comprehensive Portfolio of Custom Prototype Software Engineering Services"
            aidevDesc="Our development solutions propel your Prototype Software to the forefront of the market competition. With the proper utilization of the latest technologies, we, as an experienced Prototype Software development company, create immersive user experiences that adapt to ever-evolving trends."
