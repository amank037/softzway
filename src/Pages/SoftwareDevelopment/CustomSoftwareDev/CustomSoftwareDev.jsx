...
const softwareServices = [
  ...
  },
  {
    ...
    description: "Our software experts are globally known for building high-impact solutions across diverse cloud environments. Gain unparalleled scalability and cost efficiency with resilient cloud-native apps."
  },
  {
...
function CustomSoftwareDev() {
    return (
        ...
        <Tabs />
        <AIDevelopment
            aidevTitle="A Comprehensive Portfolio of Custom Software Engineering Services"
            aidevDesc="Our development solutions propel your software to the forefront of the market competition. With the proper utilization of the latest technologies, we, as an experienced Software development company, create immersive user experiences that adapt to ever-evolving trends."
