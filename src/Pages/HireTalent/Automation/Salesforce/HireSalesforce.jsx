...
const salesforceServicesData = [
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/software-red.png",
        title: "Custom Salesforce Solutions",
        description: "Hire Salesforce developers who specialize in crafting scalable, customized, and stable Salesforce solutions tailored to your business needs. Our company offers end-to-end support to ensure your CRM goals are met with precision and effectiveness."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/UIUX-red.png",
        title: "UI/UX Design",
        description: "Hire Salesforce developers to enhance the visual appeal and usability of your Salesforce applications by integrating the latest UI/UX design trends. They work diligently to create a memorable and engaging experience for your end users."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/api-red.png",
        title: "API & Integrations",
        description: "Hire dedicated Salesforce developers to integrate next-gen technologies like AI, Cloud, and IoT, and to connect your Salesforce platform with third-party services and APIs."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/swift-2.png",
        title: "Apex & Lightning",
        description: "Hire Salesforce developers to build and customize solutions using Apex, Lightning Components, and other Salesforce technologies, ensuring your business processes are automated and optimized."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/migration-red.png",
        title: "Migration",
        description: "Hire Salesforce programmers to migrate your existing CRM or business data to Salesforce, ensuring data integrity, security, and improved maintainability."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/red-upgradation-2.png",
        title: "Upgradation",
        description: "Hire Salesforce programmers to upgrade and refactor your Salesforce solutions, ensuring they remain bug-free, secure, and optimized for future growth."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/game-testing-1.png",
        title: "App Testing",
        description: "Our Salesforce developers implement automated testing and rigorous QA processes to ensure your Salesforce apps are reliable, secure, and bug-free."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/maintenance-red.png",
        title: "Maintenance",
        description: "Receive ongoing support and maintenance for your Salesforce solutions to keep your systems up-to-date, secure, and running smoothly."
    }
]
...
const benefits = [
    {
        heading: "Versatile CRM Deployment",
        desc: "Salesforce enables seamless deployment of CRM solutions across industries, ensuring your business processes are universally accessible and efficient."
    },
    {
        heading: "Stability & Security",
        desc: "Experience the security, stability, and reliability of Salesforce, guaranteeing continuous uptime for your business operations."
    },
    {
        heading: "Accelerated Business Growth",
        desc: "Leverage Salesforce’s robust platform to develop feature-rich solutions swiftly, reducing time-to-market and driving business growth."
    },
    {
        heading: "Exceptional User Experience",
        desc: "With Salesforce, enjoy superior user experiences and tailored UI design, making it a preferred choice for CRM and automation."
    }
]

const salesforceFaqItems = [
    {
        title: "Why should I hire a Salesforce developer?",
        description: "Hiring a Salesforce developer ensures your CRM is customized to your unique business requirements, scalable, secure, and future-ready."
    },
    {
        title: "How long does it take to develop a Salesforce solution?",
        description: "The development timeline depends on the project's complexity, features, and integrations. Simple Salesforce solutions can be built in a few weeks, while more complex implementations may take several months."
    },
    {
        title: "Will my Salesforce solution integrate with other systems?",
    ...
    {
        title: "Do you provide post-launch support for Salesforce solutions?",
        description: "Absolutely! We offer ongoing maintenance, updates, and technical support to keep your Salesforce solution running smoothly and up-to-date."
    },
    {
        title: "Can you help with deployment and scaling?",
        description: "Yes, we assist with deploying your Salesforce solution and ensure it is scalable, secure, and optimized for performance."
    }
]

function HireSalesforce() {
    return (
        <div>
            <HireLanding
            ...
            <AIDevelopment
                ...
                aidevDesc="Hire Salesforce developers from Softzway who bring your vision to life with advanced technological expertise and industry best practices."
                aidevGrid={salesforceServicesData}
                columns={4}
            />
            <HireTable
            ...
            />
            <HireCta
                title="Want to build a robust CRM solution using Salesforce?"
                description="Hire Salesforce developers from Softzway Technologies to plan, execute, and infuse brilliance into your projects."
                image="https://www.redappletech.com/wp-content/uploads/2024/07/Rectangle-83-1.png"
            />
            <AIFaq
                aiFaqItems={salesforceFaqItems}
            />
        </div>
    )
}
