...
const mernServicesData = [
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/software-red.png",
        title: "Custom MERN Stack Solutions",
        description: "Hire MERN stack developers who specialize in crafting scalable, customized, and stable web applications tailored to your business needs. Our company offers end-to-end support to ensure your project goals are met with precision and effectiveness."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/UIUX-red.png",
        title: "UI/UX Design",
        description: "Hire MERN stack developers to enhance the visual appeal of your web applications by integrating the latest UI/UX design trends. They work diligently to create a memorable and engaging experience for your end users."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/api-red.png",
        title: "API & Integrations",
        description: "Hire dedicated MERN stack developers to integrate next-gen technologies and connect your software with third-party services and APIs."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/swift-2.png",
        title: "Migration & Modernization",
        description: "Hire MERN stack developers to migrate your legacy systems to the MERN stack, ensuring data integrity, security, and improved maintainability."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/migration-red.png",
        title: "Feature Enhancement",
        description: "Hire MERN stack programmers to enhance your existing solutions by integrating new features and functionalities, boosting usability and performance."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/red-upgradation-2.png",
        title: "Upgradation & Refactoring",
        description: "Hire MERN stack programmers to upgrade and refactor your software, ensuring it remains bug-free, secure, and optimized for future growth."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/game-testing-1.png",
        title: "Testing & QA",
        description: "Our MERN stack developers implement automated testing and rigorous QA processes to ensure your applications are reliable, secure, and bug-free."
    },
    {
        image: "https://www.redappletech.com/wp-content/uploads/2024/01/maintenance-red.png",
        title: "Maintenance & Support",
        description: "Receive ongoing support and maintenance for your MERN stack applications to keep your systems up-to-date, secure, and running smoothly."
    }
]
...
const benefits = [
    {
        ...
        desc: "MERN stack enables seamless deployment across web platforms, ensuring your applications are universally accessible."
    },
    {
        heading: "Stability & Security",
        desc: "Experience the security, stability, and reliability of MERN stack solutions, guaranteeing continuous uptime for your business operations."
    },
    {
        heading: "Accelerated Market Reach",
        desc: "Leverage MERN stack expertise to develop feature-rich solutions swiftly, reducing time-to-market significantly."
    },
    {
        heading: "Exceptional User Experience",
        desc: "With MERN stack development, enjoy superior user experiences and tailored UI design, making it a preferred choice for modern businesses."
    }
]

const mernFaqItems = [
    {
        title: "Why should I hire a MERN stack developer?",
        description: "Hiring a MERN stack developer ensures your project is handled end-to-end, from frontend to backend, resulting in cohesive, scalable, and maintainable solutions."
    },
    {
        title: "How long does it take to develop a MERN stack application?",
        description: "The development timeline depends on the project's complexity, features, and integrations. Simple MERN stack solutions can be built in a few weeks, while more complex applications may take several months."
    },
    {
        title: "Will my MERN stack application integrate with other systems?",
    ...
    {
        title: "Do you provide post-launch support for MERN stack applications?",
        description: "Absolutely! We offer ongoing maintenance, updates, and technical support to keep your MERN stack application running smoothly and up-to-date."
    },
    {
        title: "Can you help with deployment and scaling?",
        description: "Yes, we assist with deploying your MERN stack application and ensure it is scalable, secure, and optimized for performance."
    }
]

function HireMERNStack() {
    return (
        <div>
            <HireLanding
            ...
            <AIDevelopment
                ...
                aidevDesc="Hire MERN stack developers from Softzway who bring your vision to life with advanced technological expertise and industry best practices."
                aidevGrid={mernServicesData}
                columns={4}
            />
            <HireTable
            ...
            />
            <HireBenefits
                title="Benefits of Hiring our Dedicated MERN Stack Developers"
                description="Hire MERN stack developers who have in-depth knowledge of MongoDB, Express, React, and Node.js to build secure, scalable, and high-performing solutions."
                benefits={benefits}
                image="/hire1.png"
            />
            <HireBenefits2
            ...
            />
            <HireCta
                title="Want to build a robust application with MERN stack expertise?"
                description="Hire MERN stack developers from Softzway Technologies to plan, execute, and infuse brilliance into your projects."
                image="https://www.redappletech.com/wp-content/uploads/2024/07/Rectangle-83-1.png"
            />
            <AIFaq
                aiFaqItems={mernFaqItems}
            />
        </div>
    )
}
